<template>
	<div class="main-content" :style='{"minHeight":"100vh","padding":"30px 0","background":"url(http://codegen.caihongy.cn/20230328/e3b3ef59d7a44ae6afcff886f7a76b98.jpg) no-repeat center bottom / 100% 100%","height":"auto"}'>
		<!-- 列表页 -->
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 30px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","margin":"0 0 0 30px","borderRadius":"3px","background":"#fff","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#7e7a59","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"600","height":"40px"}' class="item-label">订单编号</label>
						<el-input v-model="searchForm.orderid" placeholder="订单编号" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#7e7a59","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"600","height":"40px"}' class="item-label">商品名称</label>
						<el-input v-model="searchForm.goodname" placeholder="商品名称" clearable></el-input>
					</div>
					<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 34px","outline":"none","margin":"0 0px 0 10px","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"16px","minWidth":"100px","height":"40px"}' type="success" @click="search()">查询</el-button>
				</el-row>

				<el-row :style='{"padding":"10px 10px 15px","margin":"20px 0px 20px","borderRadius":"8px","flexWrap":"wrap","background":"linear-gradient(180deg, rgba(246,245,232,1) 50%, rgba(232,230,212,1) 100%),#e8e6d4","display":"flex","width":"100px","position":"fixed","right":"50px","justifyContent":"center","zIndex":"999"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>


					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						<!-- 导出excel -->
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' type="danger">导出</el-button>
					</download-excel>


					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量</el-button>

					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}'	v-if="isAuth('orders'+'/'+orderStatus,'品销量')"	type="warning"	@click="goodnameNumberChartDialog()">商品销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="warning" @click="goodtypeNumberChartDialog()">类型销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">商品销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 0px 10px 0","borderColor":"#666","color":"#333","minWidth":"80%","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0 0 1px","width":"100%","fontSize":"16px","borderStyle":"solid","height":"36px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销额')" type="warning" @click="goodtypeAmountChartDialog()">类型销额</el-button>
				</el-row>
			</el-form>
			...
			<!-- <div> -->
				<el-table class="tables"
					:stripe='false'
					:style='{"padding":"0","borderColor":"#eee","margin":"20px 180px 20px 30px","borderRadius":"5px","borderWidth":"1px 1px 0 1px","background":"#fff","width":"calc(100% - 210px)","borderStyle":"solid"}' 
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>

							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'物流')" type="primary" size="mini" @click="logisticsUpdate(scope.row.id)">物流</el-button>
                
							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'发货')" type="primary" size="mini" @click="updateHandler(scope.row)">发货</el-button>

							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'确认收货')" type="primary" size="mini" @click="updateHandler2(scope.row)">确认收货</el-button>




							<el-button :style='{"border":"1px solid #e8e6d4","cursor":"pointer","padding":"0 15px","margin":"0 5px 6px","outline":"none","color":"#7e7a59","borderRadius":"30px","background":"linear-gradient(180deg, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
